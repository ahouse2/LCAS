...
class LCASMainGUI:
    ...
    def setup_analysis_tab(self):
        ...
        self.analysis_log = scrolledtext.ScrolledText(progress_frame, height=10)
    ...
    def setup_results_tab(self):
        ...
        # Results tree
        self.results_tree = ttk.Treeview(results_frame, columns=('Plugin', 'Status', 'Score'), show='tree headings')
